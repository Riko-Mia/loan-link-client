    ...
    return (
        <div className='max-w-[1440px]  mx-auto'>
            <div  className="my-20 text-center" >
                <h1 className="text-5xl font-extrabold text-slate-900 tracking-tight mb-4">All Loans</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-center mx-auto pb-10">
